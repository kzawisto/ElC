...
bool TestScene3::init()
{
    ...
    auto closeItem = MenuItemImage::create(
                                           "CloseNormal.png",
                                           "CloseSelected.png",
                                           CC_CALLBACK_1(TestScene3::menuCloseCallback, this));
  ...
  ;
    ...
    grid = GridNode::createTwGrid({0,0},size,spacing,howMany);
...
//    auto gridTri21 = GridNode::createTriGrid({0,size*sqrt(3)-sideSize*(0.5 + sqrt(3)/3)},sideSize,spacing,false);
    ...
    vec1= {grid,gridTri1,gridTri2,gridTri3,gridTri4,gridsqr};//,grid2,,gridTri11,gridTri21};
...
//        	}
    ...
    auto touchListener = EventListenerTouchOneByOne::create();
       touchListener->onTouchBegan = CC_CALLBACK_2(TestScene3::onTouchBegan, this);
       touchListener->onTouchEnded = CC_CALLBACK_2(TestScene3::onTouchEnded, this);
       touchListener->onTouchMoved = CC_CALLBACK_2(TestScene3::onTouchMoved, this);
...
void TestScene3::menuCloseCallback(Ref* pSender)
{
...
bool TestScene3::onTouchBegan(cocos2d::Touch* touch, cocos2d::Event* event) {
...
void TestScene3::onTouchEnded(cocos2d::Touch* t, cocos2d::Event* e) {
}

void TestScene3::onTouchMoved(cocos2d::Touch* t, cocos2d::Event* e) {
}
